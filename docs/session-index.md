...
| Date | Topic | Commits | Retrospective |
|------|-------|---------|---------------|
| 2026-05-11 | Admin overhaul, mobile responsive, Telegram UX, magic login | `080e437`, `1e8169d` | [retrospective](retrospectives/2026-05-11-admin-overhaul-mobile-telegram.md) |
...
| 2026-05-17 | Security hardening: OWNER_FIREBASE_UID guard activated, iOS Safari OAuth redirect fallback | `1565694` | (see retrospective above — risks resolved) |
